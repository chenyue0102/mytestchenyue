...
public:
	...
	{
		long result;
		InvokeHelper(0x2e21000, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	LPDISPATCH Add(VARIANT& Connection, LPDISPATCH Destination, VARIANT& Sql)
	{
		...
		InvokeHelper(0x2e22000, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, &Connection, Destination, &Sql);
		return result;
	}
	LPDISPATCH get_Item(VARIANT& Index)
	{
		...
		InvokeHelper(0x2e21001, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, parms, &Index);
		return result;
	}
