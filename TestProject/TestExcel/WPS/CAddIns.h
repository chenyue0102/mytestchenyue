...
public:
	...
	LPDISPATCH Add(LPCTSTR Filename, VARIANT& CopyFile)
	{
		...
		InvokeHelper(0x60030000, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Filename, &CopyFile);
		return result;
	}
	long get_Count()
	{
	...
	LPDISPATCH get_Item(VARIANT& Index)
	{
		...
		InvokeHelper(0x60030002, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, parms, &Index);
		return result;
	}
	LPUNKNOWN get__NewEnum()
	{
		LPUNKNOWN result;
		InvokeHelper(0x60030003, DISPATCH_PROPERTYGET, VT_UNKNOWN, (void*)&result, NULL);
		return result;
	}
