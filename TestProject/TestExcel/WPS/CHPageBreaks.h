...
public:
	...
	{
		long result;
		InvokeHelper(0x1321000, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	LPDISPATCH get_Item(long Index)
	{
		...
		InvokeHelper(0x1321001, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, parms, Index);
		return result;
	}
	...
	LPDISPATCH Add(LPDISPATCH Before)
	{
		...
		InvokeHelper(0x1412000, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Before);
		return result;
	}
