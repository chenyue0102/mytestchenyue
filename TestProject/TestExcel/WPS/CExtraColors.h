...
public:
	...
	{
		long result;
		InvokeHelper(0x2811000, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void Add(long val)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x2812000, DISPATCH_METHOD, VT_EMPTY, NULL, parms, val);
	}
	long Item(VARIANT& Index)
	{
		long result;
		static BYTE parms[] = VTS_VARIANT ;
		InvokeHelper(0x2812001, DISPATCH_METHOD, VT_I4, (void*)&result, parms, &Index);
		return result;
	}
