...
class CComboBoxes : public COleDispatchDriver
{
public:
	CComboBoxes(){} // 调用 COleDispatchDriver 默认构造函数
	CComboBoxes(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CComboBoxes(const CComboBoxes& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	{
		long result;
		InvokeHelper(0x6021000, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
