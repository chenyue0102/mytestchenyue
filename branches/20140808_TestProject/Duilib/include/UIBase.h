...
#define UI_WNDSTYLE_EX_FLOAT	(WS_EX_TOOLWINDOW | WS_EX_TOPMOST)
...
public:
	CStdString GetSkinPathName() const;
	CStdString GetSkinFileName() const;

public:
	CStdString m_strSkinFilePath;
