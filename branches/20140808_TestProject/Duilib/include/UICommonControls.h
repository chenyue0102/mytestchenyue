...
public:
	...
	bool	IsHideCaret();
	void SetHideCaret(bool bHideCaret);

	void SetEmptyTipText(LPCTSTR lpText);
	CStdString GetEmptyTipText();

	void SetEmptyTipTextColor(DWORD dwEmptyTipTextColor);
	DWORD	GetEmptyTipTextColor();
protected:
    CEditWnd* m_pWindow;
    ...
    CStdString m_sFocusedImage;
    CStdString m_sDisabledImage;
	CStdString m_sEmptyTipText;		//当edit控件文本为空的时候，显示的文字
    DWORD m_dwEditbkColor;
	bool			m_bHideCaret;			//隐藏光标
	DWORD	m_dwEmptyTipTextColor;
};
...
public:
	...
	bool GetShowButton0();
	void SetShowButton0(bool bShow);
	LPCTSTR GetButton0NormalImage();
	void SetButton0NormalImage(LPCTSTR pStrImage);
	LPCTSTR GetButton0HotImage();
	void SetButton0HotImage(LPCTSTR pStrImage);
	LPCTSTR GetButton0PushedImage();
	void SetButton0PushedImage(LPCTSTR pStrImage);
	LPCTSTR GetButton0DisabledImage();
	void SetButton0DisabledImage(LPCTSTR pStrImage);
	...
	bool GetShowButton3();
	void SetShowButton3(bool bShow);
	LPCTSTR GetButton3NormalImage();
	void SetButton3NormalImage(LPCTSTR pStrImage);
	LPCTSTR GetButton3HotImage();
	void SetButton3HotImage(LPCTSTR pStrImage);
	LPCTSTR GetButton3PushedImage();
	void SetButton3PushedImage(LPCTSTR pStrImage);
	LPCTSTR GetButton3DisabledImage();
	void SetButton3DisabledImage(LPCTSTR pStrImage);
	...
	void PaintButton0(HDC hDC);
    void PaintButton1(HDC hDC);
    void PaintButton2(HDC hDC);
	void PaintButton3(HDC hDC);
...
protected:
	...
	bool m_bShowButton0;
	RECT m_rcButton0;
	UINT m_uButton0State;
	CStdString m_sButton0NormalImage;
	CStdString m_sButton0HotImage;
	CStdString m_sButton0PushedImage;
	CStdString m_sButton0DisabledImage;
	...
	bool m_bShowButton3;
	RECT m_rcButton3;
	UINT m_uButton3State;
	CStdString m_sButton3NormalImage;
	CStdString m_sButton3HotImage;
	CStdString m_sButton3PushedImage;
	CStdString m_sButton3DisabledImage;
