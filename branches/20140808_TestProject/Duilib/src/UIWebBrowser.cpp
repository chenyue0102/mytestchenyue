...
STDMETHODIMP DuiLib::CWebBrowserUI::Invoke( DISPID dispIdMember, REFIID riid, LCID lcid,WORD wFlags, DISPPARAMS* pDispParams,VARIANT* pVarResult, EXCEPINFO* pExcepInfo,UINT* puArgErr )
{
	...
	case DISPID_STATUSTEXTCHANGE:
		...
		//  		break;
	case 273:// 273 = DISPID_NEWWINDOW3, while vs2003 sdk not support this enum value.// So we need to hard code it.
		NewWindow3(
...
HRESULT STDMETHODCALLTYPE DuiLib::CWebBrowserUI::QueryStatus(const GUID *pguidCmdGroup, ULONG cCmds,  OLECMD prgCmds[ ],  OLECMDTEXT *pCmdText )
{
	HRESULT hr = OLECMDERR_E_NOTSUPPORTED;
	return hr;
}

HRESULT STDMETHODCALLTYPE DuiLib::CWebBrowserUI::Exec(const GUID *pguidCmdGroup, DWORD nCmdID, DWORD nCmdexecopt,  VARIANT *pvaIn,  VARIANT *pvaOut )
{
	HRESULT hr = S_OK;
