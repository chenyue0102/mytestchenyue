...
BOOL CTxtWinHost::TxSetScrollPos (INT fnBar, INT nPos, BOOL fRedraw)
{
	...
	m_re->OnTxSetScrollPos(fnBar, nPos, fRedraw);
    return TRUE;
}
...
void CRichEditUI::DoAttach()
{
	if (m_pManager)
		m_pManager->AddMessageFilter(this);
}

void CRichEditUI::DoDetach()
{
	if (m_pManager)
		m_pManager->RemoveMessageFilter(this);
}
...
BOOL CRichEditUI::OnTxSetScrollPos (INT fnBar, INT nPos, BOOL fRedraw)
{
	return TRUE;
}
} // namespace DuiLib
