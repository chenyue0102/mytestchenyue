...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void onTestHttp()async{
    HttpClient httpClient = new HttpClient();
    Uri uri = new Uri(scheme: 'http', host:'httpbin.org', path: '/json');
        ...
        child: Column(
          ...
          children: <Widget>[
            Row(mainAxisAlignment:MainAxisAlignment.start,
                children:<Widget>[
                  RaisedButton(onPressed: onClickButton, textColor: Colors.black, child: Text('Toast')),
                  RaisedButton(onPressed: onAddItem, textColor: Colors.black, child: Text('AddItem')),
                  RaisedButton(onPressed: onTestHttp,textColor: Colors.black, child: Text('testHttp')),
                  RaisedButton(onPressed: onTestJson, textColor: Colors.black, child: Text('testJson')),
            ]),
            Text(
            ...
            },shrinkWrap: true,itemCount: item.length)),
          ],
        ),
      ),
